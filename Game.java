...
public class Game {
	...
	public void createGameScreen() {
		...
		mainTextArea = new JTextArea("This is the main text area. This gaem is going to be palyed");
	...
	public void talkGuard() {
		position = "talkGuard";
		mainTextArea.setText("Guard: Hello Traveler. I have never seen you around here before. \nI'm sorry but due to the strict orders we cannot let    any traveler enter the town.");
	...
	public void east() {
		position = "east";
		mainTextArea.setText("You walked into a forest and found a dead soldier. \n\n(You obtained a Long Sword)");
		weapon = "Long Sword";
		weaponLabelName.setText(weapon);
	...
	public void monsterAttack() {
		...
		monsterDamage = new java.util.Random().nextInt(7);
	...
	public void lose() {
		...
		mainTextArea.setText("Omae wa mou Shinderu! \n\n(You DIED!) \n\n <GAME OVER>");
	...
	public void ending() {		
		mainTextArea.setText("Guard: Oh you defeated the Goblin! \nThank you so much. \n\nWelcome to the Town.\n\n <THE END>");
